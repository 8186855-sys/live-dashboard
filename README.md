...
1. 注册 [Turso](https://turso.tech) 获取数据库 URL 和 Token
2. Fork 此仓库
3. 在 Hugging Face 创建 Space，选择 Docker SDK
4. 在 Space 设置中添加环境变量：
   - `TURSO_DATABASE_URL`: libsql://your-db.turso.io
   - `TURSO_AUTH_TOKEN`: your-token
   - `HASH_SECRET`: openssl rand -hex 32 生成
   - `DEVICE_TOKEN_1`: Token:设备名:显示名:平台

详细部署说明见 [Wiki - 快速部署](https://github.com/Monika-Dream/live-dashboard/wiki/快速部署)。
...
| 组件 | 技术 |
|------|------|
| 后端 | Bun + TypeScript + Turso (libSQL) |
